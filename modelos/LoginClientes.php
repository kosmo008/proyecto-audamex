...
Class LoginClientes
{
    ...
    public function servicios($idUsuarioExt)
	{
		$sql="SELECT idSolicitud FROM solicitud where cliente_idCliente ='$idUsuarioExt'";
		return ejecutarConsulta($sql);		 
	}
    ...
    {
    	$sql="SELECT idUsuarioExt,usuario,password, cliente_idCliente FROM usuarioext WHERE usuario='$login' AND password='$clave' AND condicion='1'"; 
    	return ejecutarConsulta($sql);  
    }
}
