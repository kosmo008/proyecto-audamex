    ...
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primarydash sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="menu.php"> <i class="fas fa-fw fa-home"></i> <span>AUDAMEX</span></a>
            </li>
            <!-- divisor -->
            ...
            <li class="nav-item ">
                <a class="nav-link" href="ejemplo_calendario.php"> <i class="fas fa-fw fa-calendar-alt "></i> <span>Calendario</span></a>
            </li>
             <li class="nav-item ">
                ...
                <div id="collapseClientes" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6> <a class="collapse-item" href="insert_clientes.php">
                            Alta
                        </a> <a class="collapse-item" href="cons_clientes.php">
                            Consulta
                        </a>
                    </div>
                </div>
            ...
            <li class="nav-item">
                ...
                <div id="collapseCertif" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Acciones:</h6> <a class="collapse-item" href="insert_certif.php">Alta</a> <a class="collapse-item" href="cons_certif.php">Consulta</a>
                    </div>
                </div>
            </li>
           <!-- <li class="nav-item">
