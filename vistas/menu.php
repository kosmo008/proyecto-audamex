...
if(!isset($_SESSION['idUsuarioInt']) ){
...
?>
    ...
    <link rel="stylesheet" href="../public/css/step.css">
        ...
        <section class="content">
            ...
            <section class="multi_step_form">
                <form id="msform">
                    <!-- Tittle -->
                    <div class="tittle">
                        <h2>Verification Process  <?php echo $_SESSION['permiso'];?> </h2>
                    ...
                    <fieldset>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <input type="tel" id="phone" class="form-control" placeholder="+880"> </div>
                            <div class="form-group col-md-6">
                                <input type="text" class="form-control" placeholder="+8801123456789"> </div>
                        </div>
                        <div class="done_text"> <a href="#" class="don_icon"><i class="ion-android-done"></i></a>
                            <h6>A secret code is sent to your phone. <br>Please enter it here.</h6> </div>
                    ...
                    <fieldset>
                        ...
                        <div class="passport">
                            <h4>Govt. ID card <br>PassPort <br>Driving License.</h4> <a href="#" class="don_icon"><i class="ion-android-done"></i></a> </div>
                    ...
                    <fieldset>
                        ...
                        <div class="form-group fg_2">
                            <input type="text" class="form-control" placeholder="Anwser here:"> </div>
                        <div class="form-group">
                            <select class="product_select">
                                <option data-display="1. Choose A Question">1. Choose A Question</option>
                                <option>2. Choose A Question</option>
                    ...
                    <fieldset>
                        ...
                        <button type="button" class="action-button previous previous_button">Back</button>
                        </button> <a href="#" class="action-button">Finish</a>
